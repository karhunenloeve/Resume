...
\section{Ausbildung}
\begin{twocolentry}{
		\textit{Okt. 2024 – März 2026}} \textbf{Friedrich-Alexander-Universität Erlangen–Nürnberg} \\
		\textit{M.Sc. Mathematik, Digitale Geisteswissenschaften}
\end{twocolentry}
\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item \textbf{Arbeit:} Universelle Koeffizienten und Mayer-Vietoris Sequenz für Moore Homologie
	\end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
	...
	\textit{B.Sc. Mathematik, Informatik}
\end{twocolentry}
\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item \textbf{Arbeit:} Algebraische und topologische Persistenz
	\end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
	...
	\textit{M.A. Informationswissenschaft}
\end{twocolentry}
\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item \textbf{Arbeit:} Deep Learning zur Schätzung der absorbierten Strahlungsdosis in der nuklearmedizinischen Diagnostik
	\end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
	...
	\textbf{Universität Regensburg} \\
	\textit{B.A. Deutsch, Italienisch, Informationswissenschaft, Medieninformatik}
\end{twocolentry}
\vspace{0.10 cm}
\begin{onecolentry}
	\begin{highlights}
		\item \textbf{Arbeit:} Entwicklung einer Interpunktionsplattform mit linguistischen Modulen für das Information Retrieval
	\end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
  \begin{highlights}
    \item Übungsleiter in Topologie (2023, 2026), Funktionalanalysis (2026), Analysis~3 (2024, 2026), Analysis~2 (2025), Lineare Algebra~1 (2024), Mathematik für Ingenieure~A2: Analysis (2025), Mathematik für Ingenieure~A4: Stochastik (2025), sowie Topology and Applications (2024).
